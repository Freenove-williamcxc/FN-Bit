 // thanks for github:1010technologies/pxt-makerbit-ir-receiver#v0.0.6 Provided material
...
namespace FN_Bit {
    ...
    //% blockId="FN_Bit_infrared_connect"
    ...
    //% blockId=FN_Bit_infrared_on_ir_button
    ...
    export function onIrButton(
        ...
        control.onEvent(
            action === IrButtonAction.pressed
                ? MICROBIT_MAKERBIT_IR_BUTTON_PRESSED_ID
                : MICROBIT_MAKERBIT_IR_BUTTON_RELEASED_ID,
            button === IrButton.power ? EventBusValue.MICROBIT_EVT_ANY : button,
            () => {
    ...
    //% blockId=FN_Bit_infrared_button_pressed
     ...
     */
    //% subcategory="IR Remote"
    //% blockId=FN_Bit_infrared_pressed_button
    //% block="IR button"
    //% weight=57
    ...
    //% blockId=FN_Bit_infrared_button
    //% button.fieldEditor="gridpicker"
    //% button.fieldOptions.columns=3
    //% button.fieldOptions.tooltips="false"
